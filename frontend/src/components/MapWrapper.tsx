...
function MenuWrapper() {
  ...
  const renderCustomizedLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent }: any) => {
    const radius = innerRadius + (outerRadius - innerRadius + 94) * 0.5;
       ...
       :
        <>
          <div className='grid md:grid-cols-2 place-items-center grid-cols-1'> 
            {metrics[0] && 
              <div className='md:h-[70vh] md:w-[50vw] h-[80vh] w-[100vw] mt-10'>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    <text x={500 / 2} y={10} fill="black" className='font-bold text-lg' textAnchor="middle" dominantBaseline="central">
                      <tspan x="50%" dy={-3} lengthAdjust="spacingAndGlyphs">Monthly CO2(kg) Emissions</tspan>
                    ...
                    <YAxis >
                      <Label value="Amount of CO2 Emitted (kg)" dy={-35} position="insideBottomLeft" offset={20} angle={-90} fill='black' className='font-medium'/>
                    </YAxis>
            ...
            {metrics[0] &&
              <div className='md:h-[75vh] md:w-[50vw] h-[85vh] w-[100vw] mt-20'>
                  <ResponsiveContainer width="100%" height="100%">
